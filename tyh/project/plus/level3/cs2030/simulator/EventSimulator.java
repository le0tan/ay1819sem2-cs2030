...
public class EventSimulator {
     ...
     */
    public EventSimulator(int numOfServers, int numOfSelfCheckout, int seed, double lambda, double mu, double rho, double Pr, int queueLength) {
                ...
                if(currentCustomer.status == Customer.BACK) {
                    ...
                    if(toBeAdded == null) {
                        ...
                        if(currentServer.isResting()) {
                            ...
                            customers.add(new Customer(0.0, 0.0, currentServer.getBackTime(), 0, Customer.BACK, currentCustomer.getServer(), 0.0));
